...
<div style="margin-top: 4px; font-size: 90%; font-style: italic;">
  Figure 1 shows initial Comet.Photos window upon startup. A 3D shape model of 67P appears on the left, and a control panel appears on the right.
</div>
