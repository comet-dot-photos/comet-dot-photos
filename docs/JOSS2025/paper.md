...
datasets from other Rosetta instruments, like VIRTIS [@coradini2007], MIRO [@gulkis2007], and ALICE [@stern2007] or even other small solar system body missions, like Lucy [@levison2021], Hera [@michel2022], OSIRIS-REx [@lauretta2017], and OSIRIS-APEX [@dellagiustina] could be built, and operated upon by `Comet.Photos` as well.
